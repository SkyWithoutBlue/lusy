...
const faqItems: FAQItem[] = [
    {
        id: "1",
        question:
            "Я ни разу не учавствовал в онлайн-марафоне, Он мне подойдет?",
        answer: "Благодаря поддержке тренера и менеджера в чате, вы сможете пройти марафон и получить результат.",
    },
    {
        id: "2",
        question: "Где будет проходить марафон?",
        answer: "Марафон будет проходить в закрытом сообществе ВКонтакте. Перед началом марафона наш менеджер добавит вас в чат. Там вы сможете задавать вопросы, общаться с другими участниками и получать поддержку от тренера.",
    },
    {
        id: "3",
        question: "В какое время будет проходить марафон?",
        answer: "Я буду тренироваться вместе с вами, предварительно анонсируя эфир, а так же сохранять запись эфира. Вы сможете выполнить тренировку в удобное для вас время, главное чтобы вы выполнили их в течение дня.",
    },
    {
        id: "4",
        question: "Подойдут ли тренировки для новичков?",
        answer: "Мои программы адаптированы для любого уровня подготовки. Если вы никогда не занимались спортом — начнём с базовых движений и постепенно будем усложнять нагрузку. Главное — ваше желание меняться.",
    },
    {
        id: "5",
    ...
    },
    {
        ...
        answer: "Участник должен быть не младше 18 лет. Если есть проблемы со здоровьем, то настоятельно рекомендую проконсультироваться с врачом.",
    },
    {
        id: "7",
        question:
            "Мне не нужно худеть. Я хочу привести свое тело в форму. Нарастить мышечную массу. Подойдет ли онлайн-марафон для меня?",
        answer: "Да! в марафоне мы будем работать и над рекомпозицией тела.",
    },
    {
        id: "8",
        question: "Могу ли я купить доступ к марафону для другого человека?",
        answer: "Оплачивать может любой человек, но данные нужно указать именно того, кому дарите доступ.",
    },
];
