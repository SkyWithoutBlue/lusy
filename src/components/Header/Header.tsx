                ...
                <div className="mx-auto! max-w-7xl px-6! lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="hidden lg:flex items-center">
                            <button
                                className="p-2! text-sm font-semibold text-black border-2 border-black rounded-full hover:bg-black hover:text-white transition-all duration-300 transform hover:scale-105 cursor-pointer focus:outline-none focus:ring-0 active:ring-0 focus-visible:outline-none"
                                style={{
                    ...
                    <div className="lg:hidden">
                        <div className="px-6 py-4 bg-white border-t border-gray-100 shadow-lg">
                            ...
                            <div className="p-6! pt-6!">
                                <button
                                    className="w-full p-4 text-lg font-semibold text-white rounded-xl transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-0 active:ring-0 focus-visible:outline-none"
                                    style={{
                                        backgroundColor: "#9A8A88",
                                        WebkitTapHighlightColor: "transparent",
                                    }}
                                >
                                    Записаться
