...
### Автоматическое развертывание на VPS (рекомендуется!)

**Всего 2 команды!** Скрипт сделает всё сам:

```bash
# 1. Скопируйте проект на сервер
scp -r /путь/к/проекту root@your-server:/var/www/lusy
...
Скрипт автоматически установит и настроит: Node.js, PostgreSQL, PM2, Nginx, SSL!

**Подробнее:** [КАК_РАЗВЕРНУТЬ_НА_СЕРВЕРЕ.md](./КАК_РАЗВЕРНУТЬ_НА_СЕРВЕРЕ.md)
